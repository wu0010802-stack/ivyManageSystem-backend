...
class User(Base):
    ...
    role = Column(String(20), default="teacher", comment="角色: teacher/admin/hr/supervisor/parent")
    permissions = Column(BigInteger, nullable=True, default=None, comment="功能模組權限位元遮罩 (-1=全部權限, NULL=使用角色預設; parent 恆為 0)")
    ...
    line_follow_confirmed_at = Column(DateTime, nullable=True, comment="LINE Bot 被加為好友的時刻；推播可達性旗標")
