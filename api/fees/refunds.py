...
def suggest_refund(
    ...
    with session_scope() as session:
        ...
        # F-034 同 list_fee_records — 非 admin/hr/supervisor caller 必須通過
        # assert_student_access 才能拿到該學生月費 breakdown 與請假計算結果
        # （refund-suggest 會 SELECT StudentLeaveRequest）。
