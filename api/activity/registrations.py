"""
api/activity/registrations.py — 報名管理端點（pending/match/CRUD/items/payments）

注意：靜態路由 batch-payment / export / payment-report 已拆至
registrations_static.py，並於 __init__.py 內優先 include。
"""
