...
class TestCheckSalaryMonthsNotFinalized:
    ...
    def test_raises_409_when_salary_is_finalized(self):
        ...
        from services.salary.finalize_guard import (
            assert_months_not_finalized as _check_salary_months_not_finalized,
        )
        ...
        with pytest.raises(HTTPException) as exc_info:
            _check_salary_months_not_finalized(
                session, employee_id=1, months={(2025, 3)}
            )
    ...
    def test_detail_contains_year_and_month(self):
        ...
        with pytest.raises(HTTPException) as exc_info:
            _check_salary_months_not_finalized(
                session, employee_id=1, months={(2025, 8)}
            )
    ...
    def test_checks_all_months_in_set(self):
        ...
        _check_salary_months_not_finalized(
            session, employee_id=5, months={(2025, 1), (2025, 2)}
        )
